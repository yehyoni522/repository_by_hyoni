package my.day16.d.annoymousClss;

public class MainAnnoymous {
	...
	public static void main(String[] args) {
		...
		/*
		        ...
		        인터페이스를 구현한 클래스가 "특정한 한곳에서만 사용되고 다른 곳에서는 재사용되지 않는 경우"이라면
		        ...
		        부모 클래스를 상속받는 "자식 클래스를 생성하지 않고도  객체를 만들어서 부모 클래스에 정의된 메소드를 재정의 할 수 있다"는 것이다. 
